...
define("MYSQL_DATABASE", "mclibre_base_datos_2_total");  // Nombre de la base de datos
...
function conectaDb()
{
    try {
        ...
        $tmp->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_SILENT);     //impide que se pare el script ante error
...
function creaTodo($db, $consultaCreacionTabla)
{
